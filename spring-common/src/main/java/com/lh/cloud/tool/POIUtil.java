...
public class POIUtil {
    ...
    public POIUtil(Workbook workboook) {
        this.workbook = workboook;
    }

    public POIUtil(InputStream is, String version) throws FileNotFoundException, IOException {

...
public class XLSXCovertCSVReader {
     ...
     * @throws IOException
     */
    private static List<String[]> readerExcel(String path, String sheetName, int minColumns) throws IOException, OpenXML4JException,
            ParserConfigurationException, SAXException {
    ...
    public static List<List<String>> read(String path, String sheetName, int minColumns) {
        List<List<String>> lists = new ArrayList<>();
        try {
            List<String[]> listArr = XLSXCovertCSVReader.readerExcel(path, sheetName, minColumns);
            for (String[] record : listArr) {
    ...
    public static void main(String[] args) throws Exception {
        List<String[]> list = XLSXCovertCSVReader.readerExcel("E:\\八爪鱼采集数据\\58采集数据\\案例\\未读取\\58案例采集(1).xlsx"
                , "Sheet1", 35);
